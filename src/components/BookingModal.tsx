...
export const BookingModal: React.FC<BookingModalProps> = ({ isOpen, onClose, initialConcern = '' }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    concern: initialConcern || 'Erection Firmness & Loss Mid-Way',
    note: ''
  });

  // Sync initialConcern when modal opens
  React.useEffect(() => {
    if (initialConcern) {
