          ...
          {step === "form" ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="bg-blue-50/80 border border-blue-200 rounded-xl p-3.5 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-[18px] font-bold text-[#004AAD]">
                    <s className="text-gray-400 font-normal text-[15px] mr-1.5">
                      ₹5500
                    </s>{" "}
                    ₹1,100/-
                  </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:border-[#1C5BD9] text-[13px]"
                  >
                    <option value="11:00 AM - 11:45 AM">
                      11:00 AM - 11:45 AM
                    </option>
                    <option value="01:00 PM - 01:45 PM">
                      01:00 PM - 01:45 PM
                    </option>
                    <option value="04:00 PM - 04:45 PM">
                      04:00 PM - 04:45 PM
                    </option>
                    <option value="07:00 PM - 07:45 PM">
                      07:00 PM - 07:45 PM
                    </option>
                  </select>
                </div>
              ...
              <div className="flex items-center space-x-2 text-[12px] text-gray-500 pt-1">
                ...
                <span>
                  100% Confidential. Your details are never shared with anyone.
                </span>
              </div>
            ...
            <div className="py-6 text-center space-y-4">
              ...
              <p className="text-[14px] text-gray-600 max-w-[360px] mx-auto">
                Thank you, <strong>{formData.fullName}</strong>. Our clinical
                coordinator will reach out to you via WhatsApp / Phone at{" "}
                <strong>{formData.phone}</strong> shortly to confirm your
